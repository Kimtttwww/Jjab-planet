<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.kh.Corporation.model.vo.Corporation, com.kh.common.model.vo.PageInfo"%>
        ...
        <div class="corp-top-area">
            <div class="corp-top">
                ...
                <div class="corp-interest">
                    ...
                    <div class="corp-home"><a href="">기업홈페이지></a></div>
                </div>
            </div>
            <div class="corp-aTag">
...
<%-- 		<% } %> --%>
            ...
            <button onclick="document.getElementById('popup_write').style.display='block'">팝업 창 열기</button>
            ...
            <div class="corp-review-area">
                <div class="corp-review-content">
                    ...
                    <div>
                        <button onclick="document.getElementById('popup_report').style.display='block'"">신고하기</button>
			             <!-- 팝업 창 -->
						<div id="popup_report">
						  <p>신고 내용을 작성해주세요</p>
