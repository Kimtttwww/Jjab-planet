...
<head>
    ...
    <link rel="stylesheet" href="resources/css/form/enroll.css">
        ...
        <form action="" method="">
            ...
            <div class="link-enroll">
                <div class="contract-white radius-left">
                    <a href="memberInsert.jsp" class="enroll-a contract-color">개인회원</a>
                </div>
                <div class="expand-green radius-right">
                    <a href="" class="enroll-a expand-color">기업회원</a>
                </div>
            </div>
